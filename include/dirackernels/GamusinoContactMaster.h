...
#ifndef GAMUSINOCONTACTMASTER_H
#define GAMUSINOCONTACTMASTER_H
...
class GamusinoContactMaster : public DiracKernel
{
public:
  GamusinoContactMaster(const InputParameters & parameters);
...
template <>
InputParameters validParams<GamusinoContactMaster>();

#endif // GAMUSINOCONTACTMASTER_H
