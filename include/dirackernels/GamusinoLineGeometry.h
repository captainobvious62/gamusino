#ifndef GAMUSINOLINEGEOMETRY_H
#define GAMUSINOLINEGEOMETRY_H

#include "DiracKernel.h"

class GamusinoLineGeometry;

template <>
InputParameters validParams<GamusinoLineGeometry>();

/**
 * Approximates a borehole by a sequence of Dirac Points
 */
class GamusinoLineGeometry : public DiracKernel
{
public:
  /**
   * Creates a new GamusinoLineGeometry
   ...
   */
  GamusinoLineGeometry(const InputParameters & parameters);
