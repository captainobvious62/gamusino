#ifndef GAMUSINOPQPLASTICITY_H
#define GAMUSINOPQPLASTICITY_H

#include "GamusinoInelasticBase.h"
#include <array>

class GamusinoPQPlasticity;

template <>
InputParameters validParams<GamusinoPQPlasticity>();

class GamusinoPQPlasticity : public GamusinoInelasticBase
{
public:
  GamusinoPQPlasticity(const InputParameters & parameters);
