...
#ifndef GAMUSINOCONTACTSLIPDAMPER_H
#define GAMUSINOCONTACTSLIPDAMPER_H

// Moose Includes
#include "GeneralDamper.h"

// Forward Declarations
class GamusinoConstactSlipDamper;
class AuxiliarySystem;
class DisplacedProblem;
class PenetrationLocator;

template <>
InputParameters validParams<GamusinoConstactSlipDamper>();
 ...
 */
class GamusinoConstactSlipDamper : public GeneralDamper
{
public:
  GamusinoConstactSlipDamper(const InputParameters & parameters);
...
#endif // GAMUSINOCONTACTSLIPDAMPER_H
