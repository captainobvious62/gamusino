...
InputParameters
GamusinoNonReflectingBC::commonParameters()
{
...
GamusinoNonReflectingBC::GamusinoNonReflectingBC(const InputParameters & parameters)
...
Real
GamusinoNonReflectingBC::computeQpResidual()
{
...
Real
GamusinoNonReflectingBC::computeQpJacobian()
{
  return _test[_i][_qp] * _density[_qp] *
...
Real
GamusinoNonReflectingBC::computeQpOffDiagJacobian(unsigned int jvar)
{
