...
GamusinoKernelT::GamusinoKernelT(const InputParameters & parameters)
...
/******************************************************************************/
Real
GamusinoKernelT::computeQpResidual()
{
...
/******************************************************************************/
Real
GamusinoKernelT::computeQpJacobian()
{
...
/******************************************************************************/
Real
GamusinoKernelT::computeQpOffDiagJacobian(unsigned int jvar)
{
  Real jac = 0.0;
