...
/******************************************************************************/
Real
GamusinoKernelH::computeQpResidual()
{
...
/******************************************************************************/
Real
GamusinoKernelH::computeQpJacobian()
{
  Real jac = 0.0;
...
/******************************************************************************/
Real
GamusinoKernelH::computeQpOffDiagJacobian(unsigned int jvar)
{
  Real jac = 0.0;
