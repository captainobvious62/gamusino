...
template <>
InputParameters
validParams<GamusinoKernelTimeT>()
{
    ...
    _disp_var(_ndisp)
{
  ...
  if (_has_boussinesq && !_has_pf)
  {
    ...
    mooseWarning("GamusinoKernelTimeT: using Boussinesq terms but you did not provide the pore "
...
/******************************************************************************/
void
GamusinoKernelTimeT::computeResidual()
{
...
Real
GamusinoKernelTimeT::computeQpResidual()
{
  mooseError("GamusinoKernelTimeT : computeQpResidual should not be called!!");
  return 0.0;
}
...
/******************************************************************************/
void
GamusinoKernelTimeT::computeJacobian()
{
...
Real
GamusinoKernelTimeT::computeQpJacobian()
{
  mooseError("GamusinoKernelTimeT : computeQpJacobian should not be called!!");
  return 0.0;
}
...
/******************************************************************************/
void
GamusinoKernelTimeT::computeOffDiagJacobian(MooseVariableFEBase & jvar)
{
...
Real
GamusinoKernelTimeT::computeQpOffDiagJacobian(unsigned int)
{
  mooseError("GamusinoKernelTimeT : computeQpOffDiagJacobian should not be called!!");
  return 0.0;
}
