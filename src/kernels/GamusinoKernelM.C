...
/******************************************************************************/
Real
GamusinoKernelM::computeQpResidual()
{
...
/******************************************************************************/
void
GamusinoKernelM::computeJacobian()
{
  if (_use_finite_deform_jacobian)
  {
...
/******************************************************************************/
void
GamusinoKernelM::computeOffDiagJacobian(MooseVariableFEBase & jvar)
{
