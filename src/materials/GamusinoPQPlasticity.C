...
template <>
InputParameters
validParams<GamusinoPQPlasticity>()
{
                                ...
                                RankFourTensor & tangent_operator)
{
  ...
  if (step_size < _min_step_size)
    throw MooseException("GamusinoPQPlasticity: Minimum step-size violated");
                              ...
                              bool compute_full_tangent_operator)
{
  ...
  LAPACKgesv_(&gesv_num_rhs,
              ...
              &info);
  if (info != 0)
    throw MooseException("GamusinoPQPlasticity: PETSC LAPACK gsev routine returned with error code " +
...
int
GamusinoPQPlasticity::lineSearch(Real & res2,
                              Real & gaE,
                              Real & p,
                              Real & q,
                              Real p_trial,
                                             ...
                                             RankFourTensor & cto) const
{
  ...
  catch (const MooseException & e)
  {
    ...
    mooseWarning("GamusinoPQPlasticity: Cannot invert 1+T in consistent tangent "
