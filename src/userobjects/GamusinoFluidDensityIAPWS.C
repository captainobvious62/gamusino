...
template <>
InputParameters
validParams<GamusinoFluidDensityIAPWS>()
{
...
GamusinoFluidDensityIAPWS::GamusinoFluidDensityIAPWS(const InputParameters & parameters)
  : GamusinoFluidDensity(parameters), _has_kelvin(getParam<bool>("has_kelvin"))
{
}

Real
GamusinoFluidDensityIAPWS::computeDensity(Real pressure, Real temperature, Real) const
{
...
Real
GamusinoFluidDensityIAPWS::computedDensitydT(Real pressure, Real temperature, Real) const
{
  if (_has_scaled_properties)
  {
    pressure *= _scaling_uo->_s_stress;
...
Real
GamusinoFluidDensityIAPWS::computedDensitydp(Real pressure, Real temperature) const
{
  if (_has_scaled_properties)
  {
    pressure *= _scaling_uo->_s_stress;
