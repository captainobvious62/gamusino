...
// MOOSE includes
#include "GamusinoContactMaster.h"
#include "NodalArea.h"
...
registerMooseObject("ContactApp", GamusinoContactMaster);

template <>
InputParameters
validParams<GamusinoContactMaster>()
{
...
/*******************************************************************************
Routine: GamusinoContactMaster -- Constructor
*******************************************************************************/
GamusinoContactMaster::GamusinoContactMaster(const InputParameters & parameters)
...
void
GamusinoContactMaster::timestepSetup()
{
  if (_component == 0)
...
void
GamusinoContactMaster::updateContactStatefulData()
{
...
void
GamusinoContactMaster::addPoints()
{
...
void
GamusinoContactMaster::computeContactForce(PenetrationInfo * pinfo, bool update_contact_set)
{
...
/*******************************************************************************
Routine: GamusinoContactMaster -- computeQpResidual
*******************************************************************************/
Real
GamusinoContactMaster::computeQpResidual()
{
...
/*******************************************************************************
Routine: GamusinoContactMaster -- computeQpJacobian
*******************************************************************************/
Real
GamusinoContactMaster::computeQpJacobian()
{
...
/*******************************************************************************
Routine: GamusinoContactMaster -- contactModel
*******************************************************************************/
ContactModel
GamusinoContactMaster::contactModel(std::string name)
{
...
/*******************************************************************************
Routine: GamusinoContactMaster -- contactFormulation
*******************************************************************************/
ContactFormulation
GamusinoContactMaster::contactFormulation(std::string name)
{
...
/*******************************************************************************
Routine: GamusinoContactMaster -- nodalArea
*******************************************************************************/
Real
GamusinoContactMaster::nodalArea(PenetrationInfo & pinfo)
{
  const Node * node = pinfo._node;
...
/*******************************************************************************
Routine: GamusinoContactMaster -- getPenalty
*******************************************************************************/
Real
GamusinoContactMaster::getPenalty(PenetrationInfo & pinfo)
{
  Real penalty = _penalty;
  if (_normalize_penalty)
    penalty *= nodalArea(pinfo);
