...
[Materials]
  inactive = 'concrust oceancrust conmantle oceanmantle'
  [concrust]
  ...
  [Isotropic]
    ...
    porosity_uo = porosity
    permeability_uo = permeability
    permeability_initial = '9.86e-14'
    young_modulus = 10.0e+09
    porosity_initial = 0.15
    fluid_density_uo = fluid_density
    solid_density_initial = 2600
    scaling_uo = scaling
    solid_bulk_modulus = 5.5e10
    fluid_modulus = 2.2e9
  []
[]
